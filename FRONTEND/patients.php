                ...
                <tbody>
                        <?php foreach ($filteredPatients as $patient) : ?>
                            <tr data-id="<?php echo $patient['id']; ?>">
                                ...
                                <td><?php echo $patient['barangay'] ?></td>
                                ...
                                <td>
                                    ...
                                    <!-- Email icon -->
                                    <a href="#" class="text-success sendEmailBtn" data-id="<?php echo $patient['id']; ?>" data-email="<?php echo $patient['email']; ?>"><i class="fas fa-envelope"></i></a> <!-- Email icon -->
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                ...
                <div class="modal-body">
                    ...
                    <form id="addPatientForm" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Type all applicable disorder/s (eg. autism, ataxia)"id="disorder" name="disorder" required>
                        </div>
                        <div class="form-group">
